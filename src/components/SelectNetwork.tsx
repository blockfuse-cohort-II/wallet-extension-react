    ...
    <div className="bg-black absolute top-0 w-[375px] h-screen md:w-full">
      ...
      <div className="w-[375px] md:w-full flex flex-col items-center bg-gray-600 h-full text-white">
        ...
        <div className="w-[345px] mt-2">
          <h2 className="my-4 font-bold font-poppins text-lg">
            Enabled Network
          </h2>
          {filteredNetworks.map((network) => {
            ...
            return (
              <button
                key={network}
                className="flex flex-row items-center justify-between hover:border hover:border-l-4 h-16 hover:bg-gray-300 hover:border-l-blue-400 px-2 w-full"
                onClick={() => {
